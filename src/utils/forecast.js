...
const forecast = (latitude, longitude, callback) => {
    const url = 'http://api.weatherstack.com/current?access_key=c981ea76231dee75be5caee9e1967618&query='+ encodeURIComponent(latitude) + ','  +encodeURIComponent(longitude) +'&units=f'
